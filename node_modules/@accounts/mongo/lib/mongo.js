...
var Mongo = /** @class */ (function () {
     ...
     */
    Mongo.prototype.setupIndexes = function (options) {
        if (options === void 0) { options = {}; }
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sessionCollection.createIndex('token', tslib_1.__assign(tslib_1.__assign({}, options), { unique: true, sparse: true }))];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.collection.createIndex('username', tslib_1.__assign(tslib_1.__assign({}, options), { unique: true, sparse: true }))];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.collection.createIndex('emails.address', tslib_1.__assign(tslib_1.__assign({}, options), { unique: true, sparse: true }))];
                    case 3:
                        _a.sent();
                        // Index related to the password service
                        return [4 /*yield*/, this.collection.createIndex('services.email.verificationTokens.token', tslib_1.__assign(tslib_1.__assign({}, options), { sparse: true }))];
                    case 4:
                        // Index related to the password service
                        _a.sent();
                        return [4 /*yield*/, this.collection.createIndex('services.password.reset.token', tslib_1.__assign(tslib_1.__assign({}, options), { sparse: true }))];
                    case 5:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Mongo.prototype.invalidateAllSessions = function (userId, excludedSessionIds) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var selector, excludedObjectIds;
            var _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (excludedSessionIds && excludedSessionIds.length > 0) {
                            excludedObjectIds = excludedSessionIds;
                            if (this.options.convertSessionIdToMongoObjectId) {
                                excludedObjectIds = excludedSessionIds.map(function (sessionId) {
                        ...
                        return [4 /*yield*/, this.sessionCollection.updateMany(selector, {
                                $set: (_a = {
                                        valid: false
                                    },
                                    _a[this.options.timestamps.updatedAt] = this.options.dateProvider(),
    ...
    Mongo.prototype.removeAllResetPasswordTokens = function (userId) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var id;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
